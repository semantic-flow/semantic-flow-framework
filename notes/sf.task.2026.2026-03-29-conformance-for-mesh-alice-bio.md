...
The first wave should cover the earliest completed transitions through `09-alice-bio-referenced-woven`:
...
- Start with the completed transitions through `09-alice-bio-referenced-woven`, then add later manifests as later steps are completed.
...
- [x] Validate the first nine manifests against Accord SHACL.
